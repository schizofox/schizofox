self: {
  ...
  #### fix
  gtkTheme = maybeTheme config.rum.gtk.theme;
...
in {
  ...
  config = mkIf cfg.enable {
    ...
    packages = let
      pkg = pkgs.callPackage ./firefox {
        inherit cfg self pkgs lib;
        # Make sure the profilesPath correctly referrenced
        # in the user's home directory
        profilesPath = config.directory + "/${profilesPath}";
      };
    in
